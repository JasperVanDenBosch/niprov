...
<html lang="${request.locale_name}">
  <head>
    ...
    <link href="${request.static_url('niprov:static/theme.css')}" rel="stylesheet">
  ...
  <body>
    ...
    <div class="starter-template">
      <div class="container">
        <div class="row">
          <div class="col-md-2">
            <img class="logo img-responsive" src="${request.static_url('niprov:static/pyramid.png')}" alt="pyramid web framework">
          </div>
          <div class="col-md-10">
            <div class="content">
              ...
              <p class="lead">Welcome to <span class="font-normal">${project}</span>, an&nbsp;application generated&nbsp;by<br>the <span class="font-normal">Pyramid Web Framework 1.5.7</span>. </p>
                <p class="lead">
                    <a href="${request.route_url('latest')}">latest provenance</a>
