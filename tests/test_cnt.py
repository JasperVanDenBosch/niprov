...
u'Jane Doe\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',
...
None,   #h.date              = self._fread(fid,10, 'char')
None,   #h.time              = self._fread(fid,12, 'char')
...
None,   #h.nchannels         = self._fread(fid,1,'ushort')
...
None,   #h.numsamples        = self._fread(fid,1,'ulong')
